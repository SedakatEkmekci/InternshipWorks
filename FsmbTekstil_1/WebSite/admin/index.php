...
<html>
<head>
	<title>Giriş Paneli - FSMB Tekstil</title>
<meta charset="utf-8">
...
.login-wrap{
	...
	min-height:605px;
	position:relative;
	background:url(img/textile.jpg) no-repeat center;
		...
		<div class="login-form">
			<div class="sign-in-htm">
				...
				<div class="group">
					...
					<input id="pass" type="password" class="input" data-type="password" name="parola">
				</div>
				<br>
				<div class="group">
